...
{
    public class PaisServices : Repositorio<Pais>, IPaisServices
    {
        private readonly ApplicationDbContext _context;      

        public PaisServices(ApplicationDbContext context) : base(context)
        {
            _context = context;       
        }

        public async Task<Pais> Save(Pais entidad)
        {
